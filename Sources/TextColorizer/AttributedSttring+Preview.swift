...
/**
 * Preview
 * - Fix: ⚠️️ Maybe color the char types in password view This will make the design more interesting Using Attributes to do it
 * - Description: This is a preview of how to apply different colors to
 *                specific parts of the text using attributed strings. It
 *                creates a text string with letters, numbers, and symbols
 *                and assigns different colors to each type of character.
 */
#Preview(traits: .fixedLayout(width: 400, height: 240)) { // adds frame size restriction for ipad mac etc
   /**
    * Usage example
    * - Note: Apply different colors to specific parts of the text using attributed strings
    */
